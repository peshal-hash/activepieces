    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          className,
          // After `className` so twMerge lets these override a caller's fixed
          // w-[700px]/min-w-[700px], which would otherwise exceed the viewport.
          'max-h-[calc(100dvh-2rem)] overflow-y-auto',
          'max-sm:w-[calc(100vw-2rem)] max-sm:min-w-0 max-sm:max-w-[calc(100vw-2rem)]',
        )}
        {...props}
      >
        {children}
