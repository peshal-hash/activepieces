...
export const platformProjectController: FastifyPluginAsyncTypebox = async (app) => {
    ...
    app.post('/:id', UpdateProjectRequest, async (request: FastifyRequest<{ Params: { id: string }, Body: UpdateProjectPlatformRequest }>) => {
    ...
    app.delete('/:id', DeleteProjectRequest, async (request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) => {
